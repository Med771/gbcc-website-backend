...
public final class CrmContractVisibility {

    private CrmContractVisibility() {
    }

    public static Specification<CrmContractEntity> visibleFor(AccountPrincipal principal) {
